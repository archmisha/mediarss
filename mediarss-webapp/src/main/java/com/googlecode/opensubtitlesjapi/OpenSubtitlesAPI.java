...
public class OpenSubtitlesAPI {
	...
	public List<Map<String, Object>> searchEpisode(String token, String query, int season, int episode, LANGUAGE[] languages) throws OpenSubtitlesException {
		...
		List<Map<String, Object>> result = search(token, search);
		return result;
	}
	...
	public List<Map<String, Object>> search(String token, File movie, LANGUAGE[] languages) throws OpenSubtitlesException {
		try {
			...
			return search(token, search);
		} catch (IOException e) {
			throw new OpenSubtitlesException("search error", e);
		}
	}

	private List<Map<String, Object>> search(String token, Map<String, Object> search) throws OpenSubtitlesException {
