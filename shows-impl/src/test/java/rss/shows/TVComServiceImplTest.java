...
//import rss.shows.providers.TVComServiceImpl;
//import rss.shows.dao.EpisodeDao;
...
//public class TVComServiceImplTest {
//
//	@Mock
...
//		Episode ep = new EpisodeImpl(8, 3);
//		ep.setShow(show);
//		show.getEpisodes().add(ep);
//		String page = PageDownloaderTestUtils.loadPage("how-i-met-your-mother");
//		doReturn(page).when(pageDownloader).downloadPage(tvComUrl);
//
//		Collection<Episode> episodes = tvComService.getShowData(show);
//
...
//		show.setName("house");
//		show.setTvComUrl(tvComUrl);
//		String page = PageDownloaderTestUtils.loadPage("house");
//		doReturn(page).when(pageDownloader).downloadPage(tvComUrl);
//
//		tvComService.getShowData(show);
//
...
//		show.setTvComUrl(tvComUrl);
//		String page = PageDownloaderTestUtils.loadPage("greys-anatomy");
//		doReturn(page).when(pageDownloader).downloadPage(tvComUrl);
//
//		Collection<Episode> episodes = tvComService.getShowData(show);
//
...
//		show.setTvComUrl(tvComUrl);
//		String page = PageDownloaderTestUtils.loadPage("revenge");
//		doReturn(page).when(pageDownloader).downloadPage(tvComUrl);
//
...
//		String page = PageDownloaderTestUtils.loadPage("the-o-c-search-result");
//		doReturn(page).when(pageDownloader).downloadPage(tvComUrl);
//
...
//		String page = PageDownloaderTestUtils.loadPage("no-search-results");
//		doReturn(page).when(pageDownloader).downloadPage(tvComUrl);
//
...
//		final String page = PageDownloaderTestUtils.loadPage("the-office-search-results");
//
