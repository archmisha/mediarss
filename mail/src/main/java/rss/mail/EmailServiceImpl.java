...
public class EmailServiceImpl implements EmailService {
    ...
    private void sendEmail(List<String> recipients, EmailClassification classification, String message, String errorMessage) {
        try {
            ...
            GoogleMail.Send(new InternetAddress("personal.media.rss@gmail.com", "Media-RSS Team"), "lan4ear", "84ad17ad!",
                    null, StringUtils.join(recipients, " "), title, message + EMAIL_SIGNATURE);
