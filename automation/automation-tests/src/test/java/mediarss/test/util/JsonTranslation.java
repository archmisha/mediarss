...
public class JsonTranslation {
    ...
    private static Gson gsonWithNulls = new GsonBuilder().registerTypeAdapter(JsonContent.class, new JsonContentAdapter()).serializeNulls().create();
