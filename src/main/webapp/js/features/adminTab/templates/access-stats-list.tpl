<div class='stats-summary'>Total users: <span class='total-users-counter'></span></div>
<div class='access-stats-list-header'>
    <div class="access-stats-name-column-header">Name</div>
