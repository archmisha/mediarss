<div>
    ...
    <img src="images/pending.jpg" width="20" height="20" class='movie-torrent-item-scheduled-image'
         title="Torrent Scheduled for Download"/>
    <img src="images/complete.png" width="16" height="16" class='movie-torrent-item-downloaded-image'
