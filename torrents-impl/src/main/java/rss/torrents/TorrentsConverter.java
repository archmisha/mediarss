...
public class TorrentsConverter {
    ...
    protected <T extends UserTorrentJSON> T populate(T userTorrentVO, UserTorrent userTorrent) {
    ...
    protected <T extends UserTorrentJSON> T populate(T userTorrentVO, Torrent torrent) {
