...
//@Ignore
//public class TorrentSearcher1337xTest {
//
//	@Mock
...
//		when(pageDownloader.downloadPage(any(String.class))).thenReturn(PageDownloaderTestUtils.loadPage("suits-s01e01-search-results")).thenReturn(loadPage("suits-s01e01"));
//		mockFilterReturnAll();
//
...
//		when(pageDownloader.downloadPage(any(String.class))).thenReturn(PageDownloaderTestUtils.loadPage("1337x-taken2-search-results")).thenReturn(loadPage("1337x-taken2"));
//		mockFilterReturnAll();
//
//		SearchResult searchResult = torrentSearcher1337x.search(new SingleEpisodeRequest(null, "suits", new Show(), MediaQuality.HD720P, 1, 1));
//
...
//		when(pageDownloader.downloadPage(any(String.class))).thenReturn(PageDownloaderTestUtils.loadPage("1337x-rise-of-the-guardians-search-results")).thenReturn(loadPage("1337x-rise-of-the-guardians"));
//		mockFilterReturnAll();
//
